...
class FlashcardDisplay extends ConsumerWidget {
  ...
  const FlashcardDisplay(
      this.deckTitle, this.deckDescription, this.deckDifficulty,
      {Key? key, required this.deckId})
      : super(key: key);
                      ...
                      GestureDetector(
                        onTap: () async {
                          await ref
                              ...
                              .reportCard(currentFlashcard);
                          if (flashcardState.currentCardIndex >= 0) {
                            ref.read(flashcardStateProvider.notifier).nextCard(
                                deckId, flashcardState.currentCardIndex);
                          }
                        },
                        child: Container(
