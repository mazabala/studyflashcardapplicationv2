                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    width: maxWidth * 0.25,
                                    height:
                                        maxHeight * 0.18, // Slightly smaller
                                    decoration: BoxDecoration(
                                ...
                                ...List.generate(maxWidth < 400 ? 3 : 5,
                                    (index) {
                                  // Adjust card positioning to prevent overflow
                                  final top = illustrationHeight *
                                      (0.1 +
                                          (index *
                                              0.12)); // Reduced vertical spread
                                  final right =
                                      maxWidth * (0.05 + (index * 0.08));
                          ...
                          SizedBox(
                              height: isSmallScreen
                                  ? maxHeight * 0.03
                                  : maxHeight *
                                      0.05), // Adjusted spacing for small screens
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.only(
                                bottom: isSmallScreen
                                    ? 0 // Remove bottom padding on small screens
                                    : maxHeight * 0.01),
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
